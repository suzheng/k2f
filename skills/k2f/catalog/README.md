...
| Poster/slide page shell | `content/ex_poster_shell.json` | Page-height grid: `{auto:true}` header/footer + `{fr:1}` body; nested 2-col grid in the grower. Set `height` to page height − margins. |
