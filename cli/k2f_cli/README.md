...
| `k2f export-idml <package> -o <out-dir>` | InDesign package folder (`idml` + `Document Fonts/`); `--idml-only` for a lone file |
...
k2f export-idml examples/published/invoice.K2F -o /tmp/invoice
