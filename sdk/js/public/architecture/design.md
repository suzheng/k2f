...
- [k2f-v0.3.md](../spec/k2f-v0.3.md) — format contract (paths, fields, validation). Spec "State B" means the compile phase (`k2f_layout`); it is not a third on-disk file in the package.
