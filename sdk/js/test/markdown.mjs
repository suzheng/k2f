...
const bytes = await markdownToK2f(md, { title: "K2F", theme: "report" });
if (bytes[0] !== 0x50 || bytes[1] !== 0x4b) {
  throw new Error("markdownToK2f must return a ZIP package");
}
const emojiMd = "# x\n\n✅ Decision\n";
const emojiBytes = await markdownToK2f(emojiMd, { title: "Emoji", theme: "report" });
...
const mathBytes = await markdownToK2f("$$E=mc^2$$", { title: "Math", theme: "report" });
