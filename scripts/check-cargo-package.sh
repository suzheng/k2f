...
k2f_idml = { path = "$ROOT/export/k2f_idml" }
k2f_pdf = { path = "$ROOT/engine/k2f_pdf" }
k2f_sdk = { path = "$ROOT/engine/k2f_sdk" }
EOF

cd "$ROOT"
for c in k2f_core k2f_text k2f_math k2f_markdown k2f_package k2f_layout k2f_paint k2f_pptx k2f_docx k2f_idml k2f_pdf k2f_sdk k2f; do
